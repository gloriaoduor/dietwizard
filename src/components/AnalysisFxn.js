export const calculateBmr = (sex, weight, height, age, activityLevel) => {
  ...
  const foodGroups = [
    ...
    },
    {
      ...
      portions: [3, 4, 5],
      calPerPortion: 25,
      foodRecommendations: ["Cooked Vegetables", " Raw Vegetables", "Tomato"],
    },
    {
      name: "Fruit exchange",
      portions: [2, 3, 4],
      calPerPortion: 60,
      foodRecommendations: ["Apples", "Peach", "Orange", "Pear", "Grape Fruit"],
    },
    {
      name: "Meat exchange",
      portions: [2, 3],
      calPerPortion: 55,
      foodRecommendations: ["Beef", "Fish", "Chicken", "Omena"],
    },
    {
      name: "Milk exchange",
      portions: [2, 3, 4],
      calPerPortion: 120,
      foodRecommendations: ["Ice cream", "Fresh Milk", "Yoghurt"],
    },
    {
